...
const SOCIALS = [
  ...
  {
    label: "Facebook",
    href: "https://www.facebook.com/people/MIRI-Art-Studio/61591567031699/",
  ...
  return (
    <footer className="bg-primary px-6 pb-8 pt-16 text-white">
      <div className="mx-auto grid max-w-6xl gap-10 md:grid-cols-3">
        <div>
          ...
          <p className="mt-4 max-w-xs text-sm leading-relaxed text-white/60">
            MIRI гийн уран бүтээлийн ертөнцөөр хамтдаа аялцгаая.
          </p>
        </div>
      ...
      <div className="mx-auto mt-12 max-w-6xl border-t border-white/10 pt-6 text-center text-sm text-white/40">
        &copy; {new Date().getFullYear()} {` `} Miri Art Studio. Бүх эрх хуулиар
        хамгаалагдсан. <br className="md:hidden" />
        &hearts;
      </div>
    </footer>
  );
